...
The single-role machine-readable output uses schema `career_fit.v0.5`; role comparison uses `career_fit.compare.v0.4`. Details are in [docs/data-contract.md](docs/data-contract.md). The scoring choices are documented in [docs/methodology.md](docs/methodology.md).
